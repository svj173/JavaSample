...
public class EncDecBySimm2
{
     ...
     *                   decrypter instances.
     */
    EncDecBySimm2 (SecretKey key, String algorithm)
    {
        try {
     ...
     *                   decrypter instances.
     */
    EncDecBySimm2 (String passPhrase)
    {
    ...
    public static void testUsingSecretKey() {
        try {
            ...
            EncDecBySimm2 desEncrypter      = new EncDecBySimm2(desKey, desKey.getAlgorithm());
            EncDecBySimm2 blowfishEncrypter = new EncDecBySimm2(blowfishKey, blowfishKey.getAlgorithm());
            EncDecBySimm2 desedeEncrypter   = new EncDecBySimm2(desedeKey, desedeKey.getAlgorithm());
    ...
    public static void testUsingPassPhrase() {
        ...
        // Create encrypter/decrypter class
        EncDecBySimm2 desEncrypter = new EncDecBySimm2(passPhrase);
