 ...
 *
 * Требует библиотеки com.sun.image.codec.jpeg
 *
 * Рисует график (линией) , с осями. Сохраняет его в файле.
 * - Создает буфер - BufferedImage
 * - Берет от него обьект Graphics2D graphics
 * - Рисует в графикс
 * - Скидывает обьект в файл, используя JPEGImageEncoder
 *
...
public class StockGraphProducer implements ImageProducer
{
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
       FileOutputStream f = new FileOutputStream("/home/svj/tmp/stockgraph.jpg");
