...
/**
 * java Ping -c 8 -s 40 -i 100 www.google.com
 * java Ping -c 8 -s 40 -i 100 192.168.0.215
 *
 * 8 packets transmitted, 0 packets received, 100% packet loss
 *
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 16.07.2010 11:18:43
 */
public class Ping2
{
    ...
    static void init () throws IOException
    {
        ...
        outPacket = new DatagramPacket ( outBuffer, outBuffer.length, InetAddress.getByName ( host ), port );
    ...
    {
        System.out.println ( sent + " packets transmitted, " +
