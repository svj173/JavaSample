...
/**
 * Вариант для скроллинга. Что-то неработает.
 * <BR/> I am trying to add a Horizontal Scroll Bar to my Line, High/Low, Candelstick Finencial diagrams.
 * I would like to sroll just the Graphs, the Vertical axis should remain visible on the side(s).
Could someone help me, how to solve this problem with the JFreeChart?
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 28.06.2011 16:03:29
 */
