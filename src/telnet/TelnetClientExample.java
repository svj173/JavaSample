 ...
 * <p>
 * Also, use of the sendAYT(), getLocalOptionState(), getRemoteOptionState() is demonstrated.
 * When connected, type AYT to send an AYT command to the server and see the result.
 * Type OPT to see a report of the state of the first 25 options.
 * <p>
 * @author Bruno D'Avanzo
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 24.05.2012 14:55:00
 */
public class TelnetClientExample implements Runnable, TelnetNotificationHandler
{
    ...
    /***
     * Reader thread.
     * Reads lines from the TelnetClient and echoes them on the screen.
     * Команды определяются по концу строки \n.
     ***/
    public void run()
    {
