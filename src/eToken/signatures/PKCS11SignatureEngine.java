...
import eToken.adapters.TokenPrivateKey;
...
public class PKCS11SignatureEngine extends Signature
{
	 ...
	 */
	//todo protected AlgorithmID hashAlgorithm_;
     ...
     */
    protected PKCS11SignatureEngine ( String algorithm )
    {
        super ( algorithm );
    }
	...
	*/
	    ...
	    throws SignatureException
	{
        ...
        //toBeEncrypted = digestInfoEngine.toByteArray();
