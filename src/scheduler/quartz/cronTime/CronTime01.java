 ...
 * <BR/> Обьект инсталлируем только раз, а потом у него спрашиваем дату след старта.
 * <BR/> Работает.
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 17.03.2011 10:55:51
 */
public class CronTime01
{
    private CronExpression cronExpression;

    public CronTime01 ( String cronTime ) throws ParseException
    {
    ...
    * Год (необязательное поле)
        ...
        try
        {
            cronObject = new CronTime01(cronTime);
