package swing.table.multiLineCell;


/**
 * Таблица в которой в ячейке текст выводистя в неcколкьо строк.
 * <BR/> Реализовано в рендерере - Компонент получает BoxLayout.Y_AXIS.
 * <BR/> Данные по ячейке поступают как массив Object[].
 * <BR/> Каждый обьект заносится отдельно.
 * <BR/>
 * <BR/> Также реализована черезстрочная отрисовка, со сменой фона и цвета букв.
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 29.07.2011 15:55:14
 */
