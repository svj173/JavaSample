...
/**
 * Использование контекстного меню на ячейке таблицы.
 *
                    ...
                    public void actionPerformed ( ActionEvent e )
                    {
                        ...
                        if ( value instanceof Integer )
                        {
                            ...
                            getTableModel().setValueAt (
                                    new Integer ( currentValue.intValue () + changeValue.intValue () ), rowIndex, columnIndex );
                        }
                    }
                };
