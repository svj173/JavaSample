...
/**
 * Собственная таблица. С через-строчными отрисовками. 
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 14.06.2011 16:52:10
 */
...
public class ETable extends JTable
{
    ...
    {
        //return ( row % 2 == 0 ) ? GuiUtilities.ALTERNATE_ROW_COLOR : getBackground (); // не нашел GuiUtilities.ALTERNATE_ROW_COLOR
