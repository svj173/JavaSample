package swing.table.tableTree;


/**
 * Выводит в таблице деревянные параметры. Т.е. в парвой колокне отображаются деревянные обьекты с кнопочками  - развернуть, закрыть.
 * Все сотальные колонки - параметры этого обьекта.
 * Применяется сторонняя библиотека org.eclipse.swt
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 13.06.2013 11:07
 */
