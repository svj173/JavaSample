...
/**
 * Пример фокуса. По таб - бегает толкьо по компонентам одного уровня, у которых isFocusable=true.
 * <BR/> Обьект MyPanel - здесь игнорируется. А если выбрать внутри него кнопки - то по таб бегать будем только внутри MyPanel (isFocusCycleRoot=true).
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 28.06.2011 9:13:27
 */
import javax.swing.*;
import java.awt.*;
