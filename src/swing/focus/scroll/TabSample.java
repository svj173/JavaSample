...
/**
 * Пример использвоания фокуса.
 * <BR/> Есть: панель с верткиально-расположенными текстовыми полями. Все в панель не входят, следовательно - скроллинг.
