...
{
    private Logger logger = LogManager.getFormatterLogger ( TextSamplerDemo.class );
    ...
    public TextSamplerDemo()
    {
        ...
        //Create a swing.label to put messages during an action event.
        ...
        paneScrollPane.setVerticalScrollBarPolicy(
                        JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
        paneScrollPane.setPreferredSize(new Dimension(500, 155));
    ...
    private JTextPane createTextPane() {
        ...
        try {
            for (int i=0; i < initString.length; i++)
            {
                ...
                System.out.println (" - " + i + ". str = " + initString[i]
                        + ", styleName = " + initStyles[i]
