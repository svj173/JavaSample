 ...
 * <BR> Time: 17:45:24
 */
public class Title2Action extends StyledEditorKit.StyledTextAction
{
    //private StyleSet    title2;
    private SimpleAttributeSet title2;
    ...
    public Title2Action()
    {
        ...
        title2.addAttribute("titleName", "title2");
        //title1.setName("title1");
        StyleConstants.setBold(title2, false);
        //StyleConstants.setAlignment(title2,StyleConstants.ALIGN_CENTER);
        StyleConstants.setForeground(title2, Color.GREEN );
    }
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (editor != null)
        {
            ...
            setCharacterAttributes(editor, title2, false);
