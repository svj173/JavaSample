...
/**
 * Окно на три панели. Две верхние - по горизонтали. Нижняя -по вертикали, от них обоих. Четко видна разделительная граница со стрелочками вправо-влево.
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 11.07.12 8:49
 */
public class SplitPaneDemo2 extends JFrame    implements ListSelectionListener
{
    ...
    public SplitPaneDemo2 ()
    {
        ...
        splitPane = new JSplitPane ( JSplitPane.VERTICAL_SPLIT, top, label );
