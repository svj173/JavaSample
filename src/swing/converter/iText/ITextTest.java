...
public class ITextTest
{
    public static void main ( String[] args ) throws DocumentException, MalformedURLException, IOException
    {
        ...
        PdfWriter writer = PdfWriter.getInstance ( document, new FileOutputStream ( "/home/svj/tmp/ITextTest.pdf" ) );
        ...
        Paragraph element = new Paragraph ( "Some more text on the first page with different color and font type.",
