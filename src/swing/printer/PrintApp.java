...
/**
 * Образец печати HTML текста.
 * Есть
 * - preview - пока текста постранично
 * - натсройки размерво страницы и отступов
 * Нет
 * - выборки принтера из списка и индивидуальные настройки принтера (две стороны, одна, кол-во копий, номера страниц и т.д.)
 */
