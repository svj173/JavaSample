...
/**
 * Диалог.
 * <BR/> Вверху горизонтально расположены комб-боксы выборки.
 * <BR/> В центре - пример результата.
 * <BR/> Без выборки цвета.
 * <BR/>
 * <BR/> User: svj
 * <BR/> Date: 22.08.2011 9:46:36
 */
public class FontChooserDialog extends JDialog {
  ...
  public static void main(String[] args) {
    ...
    final FontChooserDialog chooser = new FontChooserDialog(frame);
