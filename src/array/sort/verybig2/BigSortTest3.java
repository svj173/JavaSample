...
public class BigSortTest3
{
    public static void main ( String[] args )
    {
        ...
        SortComparator<DataObject>      comparator;
        ...
        //orderType   = "DESC";
        orderType   = "ASC";
        System.out.println ( "-- orderField: "+orderField+"; orderType = " + orderType );
        comparator  = new DataObjectComparator ( orderField, orderType );

        // создаём класс-сортировщик
        sort        = new FileSortObject<DataObject> ( sourceData, comparator, 3 );
