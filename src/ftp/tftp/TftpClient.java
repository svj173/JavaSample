...
public final class TftpClient
{
    ...
    public final static void main ( String[] args )
    {
        ...
        */
        ...
        remoteFilename  = "avp-test/lte8st-1.3.506.bin";
        localFilename   = "/home/svj/tmp/lte8st-1.3.506.bin";
        ...
        // Open local socket - сюда приходят пакеты от TFTP сервера
        try
        {
            tftp.open();
        }
        ...
        System.out.println ( "Open TFTP local port = " + tftp.getLocalPort() );   // 38727
        ...
        if ( receiveFile )
        {
            ...
            */
            ...
            try
            {
                ...
                System.out.println ( "load file size = " + file.length() );
            }
