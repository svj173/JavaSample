...
list может принять значение null (если доступ к папке запрещен) 
 *
...
public class FileFinder
{
    ...
    */
    private List find ( String startPath, String mask, int objectType )
        ...
        if(!mask.equals("")) {
            p = Pattern.compile ( mask, Pattern.UNICODE_CASE | Pattern.CASE_INSENSITIVE );
        }
